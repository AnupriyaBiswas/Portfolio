...
const educationItems = [
  {
    ...
    degree: "Master of Technology", // Changed to only the degree type
    subject: "Computer Science & Engineering", // Added Subject
    institute: "National Institute of Technology", // Renamed from institution
    address: "Rourkela, Odisha", // Added Institute address
    notes: "",
  },
  {
    id: 2,
    year: "Aug, 2017 – July 2023",
    degree: "Bachelor of Technology", // Changed to only the degree type
    subject: "Computer Science & Engineering", // Added Subject
    institute: "RCC Institute of Information Technology", // Renamed from institution
    address: "Kolkata, West-Bengal", // Added Institute address
    notes: "",
  },
  {
    id: 3,
    year: "Aug, 2003 – July 2019",
    degree: "Higher Secondary", // Kept as is, as it's not a 'technology' degree
    subject: "", // No specific subject for Higher Secondary in this context
    institute: "St. Xavier's Institution", // Renamed from institution
    address: "Kolkata, West-Bengal", // Added Institute address
    notes: "",
  },
];
      ...
      >
        ...
        <div id="education-timeline-container" ref={timelineContainerRef} className="relative z-10 w-full max-w-5xl mx-auto py-8 px-4">
          ...
          <img
            ...
            style={{
              top: `${dipPosition}px`,
              transition: 'top 0.05s ease-out', // Much faster transition for responsiveness
