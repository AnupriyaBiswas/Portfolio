  ...
  return (
    <>
      ...
      <section className="relative pt-20 md:pt-32 min-h-screen overflow-hidden bg-black">
        {/* Top Right Image */}
        <div className="absolute top-8 right-4 z-50"> {/* Moved down from top-4 to top-8 */}
          <Image src="/assets/fishing.png" alt="Decorative fishing illustration" width={150} height={147} /> {/* Adjusted size to maintain aspect ratio */}
        </div>
