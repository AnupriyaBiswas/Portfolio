...
const skillsDetails = {
  ...
  "DEVELOPER TOOLS & IDEs": {
    ...
    details: ["Git", "GitHub", "VS Code", "Sublime Text", "Android Studio", "Jupyter Notebook", "WordPress"],
  },
  "LIBRARIES & FRAMEWORKS": {
    categoryName: "LIBRARIES & FRAMEWORKS",
    details: ["TensorFlow", "PyTorch", "Keras", "NumPy", "Pandas", "Scikit-learn", "OpenCV", "Matplotlib", "React", "Bootstrap", "Node.js"],
  },
  "DATABASE & BACKEND": {
...
const Skills = () => {
  ...
  const [mounted, setMounted] = useState(false); // ✅ fix SSR rotation issue
  ...
  useEffect(() => {
    ...
    const animate = (time) => {
      ...
      lastTime = time;
      setRotation((prev) => (prev + delta * 0.02) % 360); // smooth
  ...
  return (
    <section id="skills" className="min-h-screen bg-black text-white relative overflow-hidden w-screen">
      {/* Animated Stars */}
      ...
      <div className="relative h-[600px] w-full flex items-center justify-center z-20">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center">
          <svg viewBox="0 0 1000 1000" className="w-full h-full max-w-[1000px] opacity-60">
            {[0, 1, 2].map((i) => {
              const spacingFactor = i * 0.20;
      ...
      {showSkillCard && detailsToShow && (
        ...
        >
          ...
          <div
            className="relative text-white p-6 sm:p-8 rounded-xl shadow-2xl max-w-2xl w-full mx-auto border-2 border-orange-600 shadow-orange-500/50 animate-fade-in bg-cover bg-center bg-no-repeat z-50"
