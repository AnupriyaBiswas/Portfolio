          ...
          <div className="w-full md:w-[60%] px-4 flex flex-col justify-between h-full max-h-[calc(100vh-250px)] md:max-h-[calc(100vh-200px)] lg:max-h-[calc(100vh-150px)]">
            {researchItems.map((item, index) => (
              ...
              >
                ...
                <div className="absolute top-0 bottom-0 left-0 w-25 md:w-20 flex items-center text-orange-200 text-6xl md:text-7xl font-bold opacity-30 pointer-events-none">
