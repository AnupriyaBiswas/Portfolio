...
const About = () => {
  return (
    <PlanetSection className="relative overflow-hidden bg-[#1b1b1d] before:content-[''] before:absolute before:inset-0 before:z-0 before:bg-[radial-gradient(circle_at_20%_30%,#2a2a2c_6%,transparent_0),radial-gradient(circle_at_80%_60%,#2a2a2c_8%,transparent_0),radial-gradient(circle_at_50%_70%,#2a2a2c_10%,transparent_0),radial-gradient(circle_at_40%_20%,#2a2a2c_7%,transparent_0),radial-gradient(circle_at_60%_40%,#2a2a2c_5%,transparent_0)] before:opacity-50 before:blur before:pointer-events-none before:animate-pulse"
