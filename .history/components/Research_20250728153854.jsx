  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full flex items-center justify-center min-h-[calc(100vh80px)] md:min-h-[calc(100vh-80px)] py-4">
          ...
          <div className="hidden md:flex w-[40%] h-full items-center justify-center relative overflow-hidden">
            <img
              src="/assets/spotlight.png" // Confirmed .jpg extension. Double-check path!
            ...
            {researchItems.map((item, index) => (
              <div
                ...
                className={`group relative my-2 p-4 md:p-5 rounded-lg overflow-hidden
                                    bg-gradient-to-r from-gray-800/80 via-gray-800/70 to-transparent to-transparent
