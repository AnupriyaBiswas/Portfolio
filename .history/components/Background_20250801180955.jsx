...
const Background = () => {
  ...
  useEffect(() => {
    ...
    // Create shooting stars with 30-60 degree angles
    const createAutomaticShootingStar = () => {
      ...
      const newShootingStar = {
        ...
        angle: angle, // Store angle for tail rotation
        direction: {
          x: deltaX,
          y: deltaY
        },
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      {/* Shooting stars with correctly oriented tails */}
      {shootingStars.map((shooting) => (
        ...
        >
          {/* Shooting star tail - pointing OPPOSITE to movement direction */}
          <div
            style={{
              position: 'absolute',
              width: '30px',
              ...
              transform: `rotate(${shooting.angle + 180}deg) translateX(-25px)`,
