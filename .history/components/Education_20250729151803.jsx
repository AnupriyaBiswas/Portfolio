    ...
    const generateStars = () => {
      ...
      for (let i = 0; i < 150; i++) {
        newStars.push({
          ...
          animationDelay: Math.random() * 10, // Keep this as a number for internal calculations
        });
      }
      setStars(newStars);
    };
  ...
  return (
    <>
      ...
      >
          ...
          {stars.map((star) => (
            <div
              ...
              style={{
                ...
                // COMBINED animation and animationDelay into one shorthand property
                ...
                // Removed the separate animationDelay property to avoid conflict
          ...
          {educationItems.map((item, index) => (
            <div
              ...
              className={`relative flex items-center md:grid md:grid-cols-2 gap-x-16
                          ${index === educationItems.length - 1 ? 'mb-0' : 'mb-8 md:mb-12'}`}
            >
              {/* Card Content */}
              <div
                className={`w-full
        ...
        {/* Education End Image - Reduced top margin */}
