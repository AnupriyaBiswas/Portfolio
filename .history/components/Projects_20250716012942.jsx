...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      {/* Heading */}
      <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-20 text-left">
      ...
      <div className="lg:flex lg:gap-12">
        ...
        {/* Desktop Tabs */}
        <div className="hidden lg:flex flex-col lg:w-1/4 space-y-4 animate-slide-in">
          ...
          {domains.map((domain) => (
            <button
              ...
              className={`text-lg font-semibold px-3 py-1 rounded-full transition-all duration-300 ${selectedDomain === domain
        ...
        {/* Projects Grid */}
        <div className="lg:w-3/4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 mt-8 lg:mt-0">
          {filteredProjects.map((project, index) => (
            <div
              key={index}
              ref={(el) => (cardRefs.current[index] = el)}
              className={`transition-all duration-700 ease-out transform opacity-0 translate-y-8 ${visibleCards.includes(cardRefs.current[index])
