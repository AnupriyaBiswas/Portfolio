      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto py-8 px-4 sm:px-4">
        ...
        {educationItems.map((item, index) => (
          ...
          >
            ...
            {/* Dot - Mobile: fixed left position, Desktop: centered */}
            <div
              className="absolute w-4 h-4 sm:w-6 sm:h-6 rounded-full bg-orange-500 border-2 border-orange-300 z-10 flex items-center justify-center left-4 md:left-1/2 transform md:-translate-x-1/2"
              style={{ top: "8px" }}
            >
