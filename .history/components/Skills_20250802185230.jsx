...
const Skills = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (width < 640) {
        ...
        setOrbitRadii({ radiusX: 600, radiusY: 200 });
        setIsSmallScreen(false);
      }
    };
  ...
  const detailsToShow = currentSkillCategory ? skillsDetails[currentSkillCategory] : null;
    ...
    <>
      ...
      >
        ...
        <div className="relative h-[600px] w-full max-w-none mx-auto flex items-center justify-center z-20">
          {/* Central Star Image */}
          <div className="absolute w-24 sm:w-32 md:w-40 h-auto z-30">
            <Image
              src="/assets/star.png"
              alt="Central Star"
              width={160}
