    ...
    const generateStars = () => {
      ...
      for (let i = 0; i < 150; i++) {
        newStars.push({
          ...
          animationDelay: Math.random() * 10, // Increased from 3 to 10 for slower blinking
        });
      }
      setStars(newStars);
    };
          ...
          {stars.map((star) => (
            <div
              ...
              style={{
                ...
                animation: `fall ${20 + Math.random() * 15}s linear infinite, twinkle ${8 + Math.random() * 12}s ease-in-out infinite`, // Slower fall and added slower twinkle
