...
const projects = [
  ...
  },
  {
    ...
    description:
      "An interactive web application designed for managing and exploring music learning resources, built with modern web technologies.",
    image: "/assets/musicalAcademy.jpg",
    link: "https://github.com/AnupriyaBiswas/MusicalAcademy",
    category: "WebDev",
    collaborators: [
      {
        name: "Suman Prasad",
  ...
  },
  {
    ...
    description:
      "A sleek, responsive website crafted to showcase the portfolio and professional journey of Paul Delta Arc, built with modern web technologies for smooth performance and design aesthetics.",
