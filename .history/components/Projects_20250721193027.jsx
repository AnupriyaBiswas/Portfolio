...
const ProjectCard = ({ project, position, activeIndex, index }) => {
  ...
  const getTransform = () => {
    ...
    if (absDistance === 2) {
      return distance > 0 
        ? 'translateX(120px) scale(0.7) rotateY(-25deg)' 
        : 'translateX(-120px) scale(0.7) rotateY(25deg)';
    }
    return distance > 0 
      ? 'translateX(180px) scale(0.55) rotateY(-35deg)' 
      : 'translateX(-180px) scale(0.55) rotateY(35deg)';
  };
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 w-[300px] text-white shadow-2xl border border-gray-700 hover:border-orange-500 transition-all duration-500">
