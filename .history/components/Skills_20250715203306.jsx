...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      {/* Orbit Section */}
      <div className="relative h-[500px] w-full max-w-[95vw] sm:max-w-[90vw] md:max-w-[80vw] lg:max-w-[70vw] xl:max-w-[65vw] mx-auto flex items-center justify-center">
        {/* Background stars */}
        ...
        {Object.entries(skillsData).map(([category, data]) => {
          const radiusX = 480; // match rx of ellipse
          const radiusY = 120; // match ry of ellipse
