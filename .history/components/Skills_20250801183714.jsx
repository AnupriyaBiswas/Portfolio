...
const Skills = () => {
  ...
  const [orbitRadii, setOrbitRadii] = useState({ radiusX: 700, radiusY: 200 });
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (width < 640) {
        setOrbitRadii({ radiusX: 700, radiusY: 250 });
        setIsSmallScreen(true);
      } else if (width < 768) {
        setOrbitRadii({ radiusX: 800, radiusY: 350 });
        setIsSmallScreen(true);
      } else if (width < 1024) {
        setOrbitRadii({ radiusX: 900, radiusY: 150 });
