      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto py-12 px-4">
          ...
          {educationItems.map((item, index) => (
            ...
            >
              <div
                // Made wider (md:w-6/12) and removed background, shadow, and border
                className={`w-full md:w-7/12 p-4 rounded-lg
              ...
              >
                <h3 className="text-xl md:text-2xl font-bold text-orange-400 mb-1 leading-tight whitespace-nowrap overflow-hidden text-ellipsis"> {/* Added whitespace-nowrap and overflow classes */}
                  {item.degree}
                </h3>
