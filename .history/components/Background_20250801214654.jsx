...
const Background = () => {
  ...
  useEffect(() => {
    ...
    const createAutomaticShootingStar = () => {
      // Angle for diagonal movement (e.g., 130 degrees for top-right to bottom-left)
      // 45 degrees for top-left to bottom-right
      // 315 degrees for top-right to bottom-left (more common for shooting stars)
      const angle = 315; // Changed to 315 degrees for a more typical shooting star path
      ...
      const travelDistance = 180; // Increased travel distance
    ...
    createAutomaticShootingStar(); // Call directly, no initial setTimeout needed
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      {/* Removed Falling stars from here to be handled by CanvasBackground for performance */}
      ...
      {shootingStars.map((shooting) => (
        <div
          ...
          style={{
            ...
            top: `${shooting.startY}%`, // Use dynamic startY
            zIndex: 10,
      ...
      <style jsx global>{`
        ...
        /* The 'fall' animation is no longer needed here as falling stars are moved to CanvasBackground */
        /* @keyframes fall { ... } */
