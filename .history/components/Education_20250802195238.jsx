      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto py-8 px-2 sm:px-4">
        ...
        {educationItems.map((item, index) => (
          ...
          >
            ...
            {/* Mobile Dot */}
            <div
              className="md:hidden absolute w-4 h-4 sm:w-6 sm:h-6 rounded-full bg-orange-500 border-2 border-orange-300 z-10 flex items-center justify-center"
              style={{ left: "24px", transform: "translateX(-50%) translateY(8px)" }}
            >
