...
const ProjectShowcase = () => {
  ...
  return (
    <>
      ...
      <section className="relative pt-4 md:pt-32 min-h-screen overflow-hidden bg-black"> {/* Reduced pt on mobile */}
        ...
        {/* Increased margin-bottom on mobile to push content down more */}
        <div className="relative md:absolute md:top-15 md:right-4 flex justify-center w-full mb-4 md:mb-0 z-10">
          <Image
            src="/assets/fishing.png"
            alt="Decorative fishing illustration"
            width={162.5}
            height={222.3}
            className="w-12 h-auto md:w-[162.5px] md:h-[222.3px]" // Even smaller on mobile (w-12)
          />
        </div>
