...
const Skills = () => {
  ...
  return (
    <>
          ...
          {Object.entries(skillsData).map(([category, data]) => {
            ...
            return (
              <div
                ...
                onClick={() => handlePlanetClick(category)} // This makes each planet clickable
              >
                <img
      ...
      {/* Skill Details Card - This section renders only when showSkillCard is true */}
      {showSkillCard && detailsToShow && (
        <div
          className="fixed inset-0 z-[100] flex items-center justify-center p-4"
          onClick={handleCloseSkillCard} // Allows closing by clicking outside the card
        >
          ...
          <div
            ...
            onClick={(e) => e.stopPropagation()} // Prevents closing the card when clicking *inside* it
          >
            ...
            <button
              ...
              onClick={handleCloseSkillCard} // Close button inside the card
            >
              &times;
            </button>
          </div>
