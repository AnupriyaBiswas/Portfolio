...
// Inside your Skills.jsx, above the Skills component or as a separate const
const skillsDetails = {
  FRONTEND: {
    ...
    details: [
      ...
      "React",
      "Bootstrap",
      "Node.js (for full-stack context)", // Assuming Node.js is relevant for full-stack frontend interaction
    ],
  },
  BACKEND: {
    categoryName: "BACKEND SKILLS",
    details: [
      "Node.js", // Explicitly for backend in this context
      "REST APIs",
    ],
  },
  "AI / ML": {
    ...
    details: [
      ...
      "OpenCV",
      "Matplotlib",
      "Python", // As the primary language for AI/ML
    ],
  },
  DATABASE: {
  ...
  TOOLS: {
    categoryName: "DEVELOPER TOOLS & LIBRARIES", // Changed category name for clarity
    details: [
      "Git",
      "GitHub",
      "VS Code",
  ...
  SYSTEMS: {
    categoryName: "OPERATING SYSTEMS & CONCEPTS", // Changed category name for clarity
    details: [
      "Linux (Ubuntu)",
      "Windows",
      "Android",
  ...
  return (
    <>
        ...
        <div className="relative h-[500px] w-[100vw] max-w-none overflow-hidden mx-auto flex items-center justify-center z-10">
          ...
          {Object.entries(skillsData).map(([category, data]) => {
            ...
            return (
              <div
                key={category}
                className="absolute flex flex-col items-center transition-transform duration-300 cursor-pointer" // Added cursor-pointer
                style={{ transform: `translate(${x}px, ${y}px)` }}
                onClick={() => handlePlanetClick(category)} // Add onClick handler
              >
                <img
      ...
      {showSkillCard && detailsToShow && (
        <div
          className="fixed inset-0 z-[100] flex items-center justify-center p-4" // Use z-[100] for higher z-index
          onClick={handleCloseSkillCard} // Close card when clicking outside
        >
      ...
      {/* Add keyframe for fade-in animation */}
      <style jsx>{`
        @keyframes fade-in {
          from {
            opacity: 0;
