      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <p 
              className={`text-lg md:text-xl text-gray-300 leading-relaxed text-left transition-all duration-1000 ease-out ${
                isVisible 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 translate-y-8'
              }`}
          ...
          >
            <img
              ...
              alt="About me"
              className="w-80 h-80 object-cover rounded-lg shadow-2xl border border-gray-800"
            />
          </div>
        </div>
        ...
        <div 
          className={`w-24 h-0.5 bg-gradient-to-r from-transparent via-white to-transparent mt-12 transition-all duration-1000 ease-out ${
            isVisible 
