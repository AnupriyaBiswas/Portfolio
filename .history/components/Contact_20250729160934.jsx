...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      // Changed to flex-col to stack children vertically
      // No justify-center here, flex-grow on content will push footer down
    ...
    >
      ...
      {/* Footer Image - Now naturally at the bottom of the flex column, within the section */}
