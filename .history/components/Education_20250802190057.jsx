        ...
        {educationItems.map((item, index) => (
          ...
          >
            ...
            <div
              ...
              style={{
                marginTop: "30px", // pushes down content on mobile
              }}
            >
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400 mb-1 leading-snug">
                {item.degree}
              </h3>
              {item.subject && (
            ...
            <div
              ...
              style={{ top: "-10px" }} // moves year label up
            >
