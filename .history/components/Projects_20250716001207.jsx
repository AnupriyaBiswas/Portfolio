    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl w-full">
          ...
          {/* Title */}
          <div
            className={`flex items-center justify-between flex-wrap gap-6 mb-20 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            style={{
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold text-left">
              <span className="text-orange-500">PROJECT</span>{" "}
              <span className="text-white">SHOWCASE</span>
            </h2>

            {/* Decorative Image (Right side of heading) */}
            <img
              src="/assets/fishing.png"
              alt="Fishing Icon"
              className="w-20 h-20 md:w-24 md:h-24 object-contain hidden sm:block"
            />
          </div>
