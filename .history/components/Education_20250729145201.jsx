        ...
        <div id="education-timeline-container" className="relative z-10 w-full max-w-5xl mx-auto py-8 px-4">
          ...
          {educationItems.map((item, index) => (
            ...
            >
              ...
              {/* Year text positioned on top of the dot */}
              <div
                  className="absolute left-1/2 transform -translate-x-1/2 text-center z-20 pointer-events-none" // pointer-events-none to ensure dot remains clickable/interactive if needed
                  style={{ top: '-12px' }} // Adjust this value to fine-tune vertical position above the dot
              >
                  <span className="text-gray-300 text-xs font-semibold whitespace-nowrap px-1 py-0.5 rounded-sm">
                      {item.year}
                  </span>
              </div>
