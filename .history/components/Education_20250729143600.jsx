...
const Education = () => {
  ...
  useEffect(() => {
    ...
    // All useEffect logic for timelineDip.png movement is removed.
    // window.removeEventListener for scroll and resize also removed.
      ...
      >
        ...
        <div id="education-timeline-container" className="relative z-10 w-full max-w-5xl mx-auto py-8 px-4">
          ...
          {educationItems.map((item, index) => (
            ...
            >
              {/* Card Content - Design adjusted for cohesiveness */}
              <div
                className={`w-full p-4 rounded-lg bg-gray-800 bg-opacity-70 shadow-md transition-all duration-300 hover:bg-opacity-90 hover:shadow-lg
                            ${
                              index % 2 === 0
