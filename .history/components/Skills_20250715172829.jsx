            ...
            <div className="relative w-full h-96 md:h-[600px] flex items-center justify-center">
              ...
              <div className="absolute z-20">
                <div className="relative">
                  ...
                  />
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-yellow-400/20 to-orange-600/20 animate-pulse"></div>
                </div>
              </div>

              {/* Orbital Rings */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-80 h-80 md:w-96 md:h-96 border border-gray-700/20 rounded-full"></div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-96 h-96 md:w-[450px] md:h-[450px] border border-gray-600/10 rounded-full"></div>
              </div>

              {/* Orbiting Skills */}
              <div className="absolute inset-0 flex items-center justify-center">
                {Object.entries(skillsData).map(([category, data], index) => {
                  const orbitRadius = 160 + (index % 2) * 40; // Varied orbit distances
                  ...
                  return (
                    ...
                    >
                      {/* Planet Glow */}
                      <div className={`absolute inset-0 bg-gradient-to-r ${data.color} rounded-full blur-lg opacity-30 group-hover:opacity-60 transition-opacity duration-500`}
                           style={{
                             width: '100px',
                             height: '100px',
                             left: '-10px',
                      ...
                      {/* Planet */}
                      <div className="relative w-20 h-20 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300 border-2 border-white/20">
                        <img 
                        ...
                        />
                        <div className={`absolute inset-0 bg-gradient-to-br ${data.color} opacity-20 mix-blend-overlay`}></div>
                      </div>
