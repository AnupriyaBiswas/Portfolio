...
const researchItems = [
  {
    ...
    summary:
      "A deep learning-based approach to improve latency and accuracy in neural interfaces for prosthetic control, allowing for more natural and responsive prosthetic control.",
  ...
  },
  {
    ...
    summary:
      "Research focusing on using EMG and IMU data fusion to differentiate gait patterns in Parkinson's disease, aiding in early diagnosis and personalized rehabilitation strategies.",
  ...
  },
  {
    ...
    summary:
      "Exploring the practical applications of quantum entanglement to develop highly secure, unhackable communication channels based on quantum key distribution protocols, a vital step for future cyber security.",
  ...
  return (
    <>
      ...
      >
        ...
        <div className="pt-20 pb-16 text-center z-10 relative px-4 w-full"> {/* Full width for heading */}
        ...
        <div className="relative z-10 w-full flex items-center justify-center min-h-[50vh]"> {/* min-h for vertical centering */}
            {/* Left Side: Spotlight Image */}
            <div className="hidden md:flex w-[40%] h-[100%] items-center justify-end relative pr-8">
                <img
                    src="public/assets/spotlight.jpg" // IMPORTANT: Adjust this path based on your project structure!
                    alt="Spotlight"
                    className="absolute h-full max-h-96 object-contain transition-transform duration-700 ease-in-out" // Smoother transition for rotation
                    style={{ transform: `rotate(${currentRotationAngle}deg)` }}
                />
            </div>

            {/* Right Side: Research Data Streams */}
            <div className="w-full md:w-[60%] px-4 md:px-0 flex flex-col justify-evenly h-full max-h-[80vh]"> {/* Adjusted height to fit 3 cards */}
                {researchItems.map((item, index) => (
                    <div
                        key={index}
                        className={`group relative my-4 p-6 md:p-8 rounded-lg overflow-hidden
