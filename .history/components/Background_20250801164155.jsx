...
const Background = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden z-0">
      ...
      <div className="fixed top-4 left-4 bg-black bg-opacity-80 text-white p-2 z-50 text-xs rounded">
      ...
      {visibleConstellations.map((c, i) => (
        <div
          key={`${c.name}-${i}`}
          className="absolute animate-fade-in-out constellation-container"
          style={{
        ...
        >
          ...
          >
            ...
            {!isMobile && hoveredConstellation === c.name && (
              <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-sm px-3 py-1 rounded pointer-events-none whitespace-nowrap z-20 border border-gray-600 shadow-lg">
      ...
      {selectedConstellation && (
        ...
        >
          <div 
            className="bg-gray-900 text-white rounded-lg p-6 max-w-md w-full max-h-96 overflow-y-auto border border-gray-700 shadow-2xl transform transition-all duration-300 scale-100"
