...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      {/* Footer Image */}
      <div className="fixed bottom-0 left-0 w-full z-20"> {/* Fixed position, at the very bottom */}
        <img
          src="/assets/footer.jpg" // Assuming footer.jpg is in your public/assets folder
          alt="Contact Page Footer"
          className="w-full h-auto opacity-70" // Full width, auto height, subtle opacity
        />
      </div>
    </section>
  );
