            ...
            >
              ...
              <div
                className={`w-full p-4 rounded-lg
                            ${
                              index % 2 === 0
                                ? "md:col-start-1 md:col-end-2 md:text-right md:pr-8 animate-[fadeInLeft_1s_ease-out_forwards]"
                                : "md:col-start-2 md:col-end-3 md:text-left md:pl-8 animate-[fadeInRight_1s_ease-out_forwards]"
                            }`}
