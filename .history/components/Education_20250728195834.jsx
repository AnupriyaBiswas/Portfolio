      ...
      >
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto py-12 px-4">
          ...
          {educationItems.map((item, index) => (
            <div
              key={item.id}
              // Reduced vertical margin even further
              className="relative mb-6 md:mb-10 flex items-center md:grid md:grid-cols-2 gap-x-16"
            >
              ...
              <div
                className={`w-full p-4 rounded-lg
                            ${
                              index % 2 === 0
                                ? "md:col-start-1 md:col-end-2 md:text-right md:pr-10 animate-[fadeInLeft_1s_ease-out_forwards]" // Adjusted padding
                                : "md:col-start-2 md:col-end-3 md:text-left md:pl-10 animate-[fadeInRight_1s_ease-out_forwards]" // Adjusted padding
                            }`}
              ...
              {/* Timeline Dot & Year - Positioned based on the card's height */}
              <div
                ...
                style={{ left: "50%", transform: "translateX(-50%) translateY(12px)" }} /* Adjust translateY to align with card top/center */
              >
              ...
              <div
                className={`hidden md:block absolute w-24 text-center font-bold text-lg
                            ${
                              index % 2 === 0
                                ? "right-[calc(50%+4rem)] text-right" // Offset from center line + dot width
                                : "left-[calc(50%+4rem)] text-left"
                            }
                            text-gray-400`}
                // Position year text vertically aligned with the dot's center
                style={{ top: "12px", animationDelay: `${0.2 * index}s` }}
              >
