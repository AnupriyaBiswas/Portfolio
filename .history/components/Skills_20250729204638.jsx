    ...
    <>
      ...
      {showSkillCard && detailsToShow && (
        ...
        >
          ...
          {/* Actual Skill Card - Changed max-w-lg to max-w-2xl */}
          <div
            className="relative text-white p-6 sm:p-8 rounded-xl shadow-2xl max-w-2xl w-full mx-auto {/* Changed max-w-lg to max-w-2xl */}
