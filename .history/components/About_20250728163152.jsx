          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                I’m a <span className="text-orange-500 font-semibold">Creative and Curious</span> Technology enthusiast, with a masters in Computer Engineering. As a passion and profession, I like exploring the intersection of software development and AI/ML (Blockchain Technologies being a bit of a Guilty Pleasure). 
                
                Currently, I’m working on <span className="text-orange-500 font-semibold">Multimodal Gait Analysis</span> using Signal Processing, aiming to bridge advanced research with practical, real-world solutions.
              </p>
