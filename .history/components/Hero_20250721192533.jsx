  ...
  return (
    <>
      ...
      <section className="relative pt-20 md:pt-32 min-h-screen overflow-hidden bg-black">
        ...
        {/* Projects Carousel - Glide.js inspired */}
        <div className="relative w-full mt-20">
          ...
          >
            <div
              ref={sliderRef}
              className="flex gap-8 overflow-x-auto scroll-smooth no-scrollbar py-8 px-4 justify-start"
              style={{ 
                scrollbarWidth: 'none', 
            ...
            >
              {filteredProjects.map((project, idx) => (
                <div key={`${selectedCategory}-${idx}`} style={{ scrollSnapAlign: 'center' }}>
                  <ProjectCard 
                    project={project} 
                    index={idx} 
            ...
            <button
              ...
              className="absolute left-2 top-1/2 transform -translate-y-1/2 z-20 bg-gradient-to-r from-gray-800 to-gray-900 p-3 rounded-full shadow-2xl border border-gray-600 hover:border-orange-500 transition-all duration-300 hover:scale-110 hover:shadow-orange-500/30"
            >
            ...
            <button
              onClick={handleNext}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 z-20 bg-gradient-to-r from-gray-800 to-gray-900 p-3 rounded-full shadow-2xl border border-gray-600 hover:border-orange-500 transition-all duration-300 hover:scale-110 hover:shadow-orange-500/30"
            >
