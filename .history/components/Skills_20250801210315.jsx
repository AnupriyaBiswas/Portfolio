import React, { useEffect, useRef, useState } from "react"; 
 ...
   const [orbitRadii, setOrbitRadii] = useState({ radiusX: 500, radiusY: 120 }); 
 ...
       } else if (width < 768) { 
         // Slightly increased radiusX for this breakpoint
         setOrbitRadii({ radiusX: 200, radiusY: 350 }); 
         setIsSmallScreen(true); 
       } else if (width < 1024) { 
         // Slightly increased radiusX for this breakpoint
         setOrbitRadii({ radiusX: 320, radiusY: 150 }); 
         setIsSmallScreen(false); 
       } else { 
         // Slightly increased radiusX for this breakpoint
         setOrbitRadii({ radiusX: 400, radiusY: 120 }); 
         setIsSmallScreen(false); 
       } 
     }; 
