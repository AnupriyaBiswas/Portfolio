...
const About = () => {
  return (
    <PlanetSection className="relative overflow-hidden bg-[#1f1f1f] before:content-[''] before:absolute before:inset-0 before:z-0 before:bg-[radial-gradient(circle_at_10%_15%,#2b2b2b_6%,transparent_7%),radial-gradient(circle_at_30%_25%,#252525_8%,transparent_9%),radial-gradient(circle_at_60%_40%,#2d2d2d_10%,transparent_11%),radial-gradient(circle_at_80%_70%,#232323_6%,transparent_7%),radial-gradient(circle_at_50%_80%,#262626_5%,transparent_6%),radial-gradient(circle_at_20%_80%,#292929_6%,transparent_7%),radial-gradient(circle_at_70%_20%,#282828_5%,transparent_6%),radial-gradient(circle_at_40%_50%,#2e2e2e_7%,transparent_8%),radial-gradient(circle_at_60%_75%,#252525_9%,transparent_10%),radial-gradient(circle_at_80%_30%,#2a2a2a_7%,transparent_8%)] before:opacity-70 before:blur-sm after:content-[''] after:absolute after:inset-0 after:z-0 after:bg-gradient-to-br after:from-white/5 after:via-transparent after:to-black/30"
