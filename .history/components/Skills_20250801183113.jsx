...
      if (width < 640) {
        // Increased radiusX for small screens
        setOrbitRadii({ radiusX: 150, radiusY: 250 });
        setIsSmallScreen(true);
      } else if (width < 768) {
        // Increased radiusX for medium screens
        setOrbitRadii({ radiusX: 250, radiusY: 350 });
        setIsSmallScreen(true);
      } else if (width < 1024) {
        // Increased radiusX for large screens
        setOrbitRadii({ radiusX: 350, radiusY: 150 });
        setIsSmallScreen(false);
      } else {
        // Increased radiusX for extra-large screens
        setOrbitRadii({ radiusX: 450, radiusY: 120 });
        setIsSmallScreen(false);
      }
    };
