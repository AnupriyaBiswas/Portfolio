    ...
    <>
      ...
      <section className="relative pt-20 md:pt-32 min-h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 px-4 md:px-16">
          <h1 className="text-6xl md:text-8xl font-bold leading-tight text-center mb-8"> {/* Changed mb-16 to mb-8 */}
            <span className="text-orange-500">PROJECT </span>
            <span className="text-white">SHOWCASE</span>
          </h1>

          {/* Category Filters */}
          <div className="flex justify-center mt-8 gap-6 flex-wrap"> {/* Changed mt-16 to mt-8 */}
            {categories.map((cat) => (
              <button
                key={cat}
        ...
        <div className="relative w-full mt-20 px-4">
          <div
            className="relative h-[500px] max-w-7xl mx-auto"
