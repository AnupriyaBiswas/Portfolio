...
const Contact = () => {
  ...
  return (
    ...
    >
      {/* Animated Stars Background - NOW IMPROVED FOR VISIBILITY WITHIN SECTION */}
      <div className="absolute inset-0 overflow-hidden z-0">
        {stars.map((star) => (
          <div
            ...
            style={{
              left: `${star.x}%`,
              // Removed `top` from here, as `fall` animation will control vertical position
              width: `${star.size}px`,
              height: `${star.size}px`,
      ...
      {/* CSS for starfall animation keyframes - Adjusted `fall` to use % for `top` */}
      <style jsx>{`
        @keyframes fall {
          0% {
