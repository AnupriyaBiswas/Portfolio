...
const Background = () => {
  ...
  useEffect(() => {
    ...
    // Generate fixed positions for constellations
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      {/* Test button to verify modal functionality */}
      <button
        className="fixed top-20 left-4 bg-green-500 text-white px-4 py-2 rounded text-xs"
        onClick={() => {
      ...
      {/* Modal using Portal - Renders directly to document.body */}
      {selectedConstellation && createPortal(
        ...
        document.body // This renders the modal directly in document.body, bypassing any z-index issues
      )}
