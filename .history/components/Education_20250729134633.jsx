import React, { useEffect, useState } => {
  ...
  // Updated educationItems based on your previous image and common chronological order
            ...
            >
              ...
              <div
                className={`w-full p-4 rounded-lg
                            ${
                              index % 2 === 0
                                ? "md:col-start-1 md:col-end-2 md:text-right md:pr-8 animate-[fadeInLeft_1s_ease-out_forwards]" // Adjusted padding for wider text
                                : "md:col-start-2 md:col-end-3 md:text-left md:pl-8 animate-[fadeInRight_1s_ease-out_forwards]" // Adjusted padding for wider text
                            }`}
              ...
              <div
                ...
                style={{ left: "50%", transform: "translateX(-50%) translateY(16px)" }} /* Aligned with top of card content */
              >
                <div className="w-2 h-2 rounded-full bg-white animate-pulse-fast"></div>
              </div>

              {/* Removed the 'Year on the line' div to prevent overlap */}
            </div>
          ))}
        </div>
