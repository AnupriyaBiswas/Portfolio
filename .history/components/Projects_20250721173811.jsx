  ...
  return (
    ...
    >
        ...
        <div className="hidden lg:flex flex-wrap gap-3 animate-slide-in">
          {domains.map((domain) => (
            <button
              ...
              className={`text-sm xl:text-base font-bold px-4 xl:px-6 py-2 xl:py-3 rounded-full transition-all duration-300 transform hover:scale-105 ${selectedDomain === domain
        ...
        <div className="relative w-full h-full flex items-center justify-center preserve-3d">
          {filteredProjects.map((project, index) => {
            ...
            return (
              <div
                key={index}
                className={`absolute transition-all duration-1200 ease-out cursor-pointer transform-gpu preserve-3d ${isCenter ? 'pointer-events-auto' : 'pointer-events-auto'
                  }`}
                style={{
              ...
              >
                <div
                  className={`w-[300px] min-h-[420px] bg-gradient-to-br backdrop-blur-md rounded-2xl border overflow-hidden transition-all duration-700 transform-gpu shadow-2xl ${isCenter
                  ...
                  <div className="p-6">
                    <div className="mb-4 flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <div
                          className={`w-3 h-3 rounded-full ${project.status === "Live"
                              ? "bg-green-500"
                    ...
                    <div className="mt-auto">
                      <a
                        ...
                        className={`inline-flex items-center justify-center w-full px-4 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 text-sm shadow-lg hover:shadow-orange-500/25 transform hover:scale-105 ${isCenter ? 'hover:scale-105' : 'hover:scale-100'
                          }`}
                      >
        ...
        <div className="flex justify-center gap-3">
          {filteredProjects.map((_, index) => (
            <button
              ...
              disabled={isAnimating}
              className={`w-3 h-3 rounded-full transition-all duration-300 disabled:cursor-not-allowed ${currentIndex === index
      ...
      <style jsx>{`
        ...
        .animate-slide-in {
          animation: slide-in 1s ease-out both;
        }
