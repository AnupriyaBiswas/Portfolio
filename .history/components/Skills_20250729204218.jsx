...
const Skills = () => {
  ...
  return (
    <>
      ...
      {/* Skill Details Card - REFINEMENTS FOR BLUR AND TRANSPARENCY */}
      {showSkillCard && detailsToShow && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black bg-opacity-70 backdrop-blur-sm"></div> {/* Added backdrop-blur-sm */}

          {/* Actual Skill Card - Removed background color, emphasized border */}
          <div
            className="relative text-white p-6 sm:p-8 rounded-xl shadow-2xl max-w-lg w-full mx-auto
                       ...
                       transform transition-all duration-300 ease-out scale-100" // Increased border width, stronger shadow
