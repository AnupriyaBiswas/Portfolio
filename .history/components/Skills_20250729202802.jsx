...
const skillsData = {
  LANGUAGES: { icon: "skill1.png", angle: 0 }, // Renamed from FRONTEND
  "DEVELOPER TOOLS & IDEs": { icon: "skill2.png", angle: 60 }, // Renamed from BACKEND (using original icon placement)
  "LIBRARIES & FRAMEWORKS": { icon: "skill3.png", angle: 120 }, // Renamed from AI / ML
  "DATABASE & BACKEND": { icon: "skill4.png", angle: 180 }, // Renamed from DATABASE
  "CONCEPTS & PARADIGMS": { icon: "skill5.png", angle: 240 }, // Renamed from TOOLS
  "OPERATING SYSTEMS": { icon: "skill6.png", angle: 300 }, // Renamed from SYSTEMS
};
