...
const Education = () => {
  ...
  useEffect(() => {
    ...
    const calculateDipPositionSmooth = () => {
      ...
      // Clamp normalizedScroll between 0 and 1
      ...
      >
        ...
        <div id="education-timeline-container" ref={timelineContainerRef} className="relative z-10 w-full max-w-5xl mx-auto py-8 px-4">
          ...
          <img
            ...
            style={{
              top: `${dipPosition}px`,
              transition: 'top 0.3s ease-out', // Smoother transition duration
            ...
            >
              ...
              <div
                ref={el => {
                  ...
                  // Ensure el exists to prevent errors if element is unmounted
