...
const Skills = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="skills"
      className="min-h-screen pt-44 relative flex items-center justify-center overflow-hidden bg-black text-white"
    >
      {/* Background stars */}
      ...
      {Object.entries(skillsData).map(([category, data], index) => {
        const radiusX = 300; // wider horizontal orbit
        const radiusY = 120; // narrower vertical orbit
