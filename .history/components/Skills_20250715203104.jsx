...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      {/* Orbit Section */}
      <div className="relative h-[500px] min-w-[1300px] w-full overflow-x-auto flex items-center justify-center">
        ...
        <img
          src="assets/star.png"
          alt="Central Star"
          className="absolute w-50 h-50 z-20 object-contain"
        />

        {/* Elliptical Orbit Visual */}
        <div className="absolute z-0">
          <svg width="1300" height="300" viewBox="0 0 1300 300" className="opacity-30">
            <ellipse
              cx="700"
              cy="150"
              rx="650"
