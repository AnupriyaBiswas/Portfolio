    ...
    >
      ...
      <div className="flex-1 max-w-3xl z-10">
        ...
        <p className="text-gray-400 text-lg md:text-xl mb-8 max-w-2xl leading-relaxed">
          Hello, I'm Anupriya Biswas, a Student of Computer Science Engineering. I have worked as a Front-end Developer. I'm passionate about Deep Learning Solutions to real-world Problems.
        </p>
