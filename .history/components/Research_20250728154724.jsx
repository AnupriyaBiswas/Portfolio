    ...
    <>
      ...
      >
            ...
            {researchItems.map((item, index) => (
              <div
                ...
                className={`group relative my-2 p-4 md:p-5 rounded-lg overflow-hidden
                                     bg-gradient-to-r from-gray-900/80 via-gray-900/70 to-transparent /* Changed from blue-950 to dark gray-900 */
                                     border border-gray-700/70 /* Changed from blue-800 to gray-700, slightly brighter opacity */
              ...
              >
                ...
                <div className="absolute top-4 left-4 text-orange-200 text-xl font-bold opacity-80">
                  {index + 1}
                </div>

                {/* Content */}
                <div className="relative z-10 pl-12 md:pl-16">
                  <h3 className="text-lg md:text-xl font-bold mb-1 text-white group-hover:text-orange-50 transition-colors duration-300 leading-tight">
                    {item.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-600/70 flex-wrap gap-2"> {/* Added flex-wrap and gap */}
                    {/* Live Demo Button */}
                    <a
                      href={item.link}
                      target="_blank"
                    ...
                    {item.github && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center px-4 py-1.5 bg-gray-700 text-gray-200 font-semibold rounded-full text-xs
                                        hover:bg-gray-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gray-600/30"
                        >
        ...
        <div className="mt-8 flex justify-center relative z-10">
          <div className="w-80 h-1.5 bg-gradient-to-r from-transparent via-orange-400/50 to-transparent rounded-full relative"> {/* Changed to orange-400 */}
            <div className="absolute inset-0 bg-orange-400/30 blur-sm rounded-full animate-[highlightStream_3s_ease-out_infinite_alternate_reverse]"></div> {/* Changed to orange-400 */}
            <div className="absolute -left-2 top-0 w-3 h-3 bg-orange-400 rounded-full animate-pulse-fast"></div> {/* Changed to orange-400 */}
            <div className="absolute -right-2 top-0 w-3 h-3 bg-orange-400 rounded-full animate-pulse-fast delay-700"></div> {/* Changed to orange-400 */}
          </div>
        </div>
