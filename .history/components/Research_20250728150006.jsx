  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full flex items-center justify-center min-h-[calc(100vh-250px)] md:min-h-[calc(100vh-200px)] py-4">
            {/* Left Side: Spotlight Image Container - Fixed */}
            <div className="hidden md:flex w-[40%] h-full items-center justify-center relative pr-8">
                <img
                    src="/assets/spotlight.jpg" // Confirmed .jpg extension
                    alt="Astronaut holding the Moon as a spotlight" // More descriptive alt text
                    className="h-auto w-full max-w-[90%] object-contain" // Adjusted max-w and removed absolute positioning within this container for simplicity
                />
            </div>

            {/* Right Side: Research Data Streams */}
            {/* Crucial overflow fix: Ensure cards fit vertically with padding/gap */}
            <div className="w-full md:w-[60%] px-4 md:px-0 flex flex-col justify-evenly h-full max-h-[calc(100vh-250px)] overflow-y-auto custom-scrollbar pr-4"> {/* Added custom-scrollbar and pr-4 for overflow */}
...
export default Research;import React, { useEffect, useState, useRef } from "react";
